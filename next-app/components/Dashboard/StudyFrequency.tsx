...
export default function StudyFrequency({ data, isLoading }: StudyFrequencyProps) {
  ...
  return (
    <Card
      ...
      <CardContent>
        ...
        {isLoading ? (
          <Typography color='text.secondary'>Lade Lernhäufigkeit ...</Typography>
        ) : data.length === 0 ? (
          <Typography color='text.secondary'>
            Noch keine Lernsessions gespeichert.
          </Typography>
        ) : (
